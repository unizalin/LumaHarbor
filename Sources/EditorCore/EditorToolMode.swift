...
///
/// `.crop` (Task 2.3), `.whiteBalance` (the eyedropper, Task 2.4) and
/// `.linearGradient` (Task 4.3) are the cases implemented so far; a future
/// spot heal mode (Task 4.5) extends this same switch rather than inventing
/// a second, parallel "what am I doing right now" flag.
